...
our twitter clone <a href="https://9ozk2orqyo.codesandbox.io" target="_blank">nitwit</a> :)
...
<ul>
  ...
  <Appear>
    ...
    <li>Child receives one props object<br/><br/></li>
  </Appear>
</ul>
...
<li>Makes your components dynamic<br/><br/></li>
  <Appear>
    ...
    <li>Where to place each part of state?<br/><br/></li>
...
<ol>
  <li>Initialize the posts array by calling useState<br/><br/></li>

  <li>Pass the hard-coded posts array as initial state to useState<br/><br/></li>
...
<li>Create a post object containing the provided content<br/>and a hard-coded username.<br/><br/></li>
...
<ul>
  <li><b>Uncontrolled</b> inputs: the old skool way<br/><br/></li>
  <Appear>
    <li><b>Controlled</b> inputs: the React way</li>
  </Appear>
</ul>
...
<ol>
  <li>Retrieve timeline:<br/> HTTP GET on /users/:userId/timeline <br/>via the useEffect hook<br/><br/></li>
  <li>Save post:<br/> HTTP POST on /users/:userId/posts <br/>in the addPost function</li>
</ol>
